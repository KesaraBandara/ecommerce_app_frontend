...
<!--      </div>-->
<!--      &lt;!&ndash;            display product details&ndash;&gt;-->
...
<!--  },-->
<!--  props: ["http://localhost:8083", "products", "categories"],-->
<!--  mounted() {-->
...
export default {
  ...
  methods: {
    addToWishlist() {
      ...
      axios
          .post(`${this.baseURL}/api/v1/wishlist/add?token=${this.token}`, {
            id: this.product.id,
          })
          .then((res) => {
            if (res.status === 201) {
